...
const steps = [
  {
    ...
    description: "Sign up in under 2 minutes. Verify your identity with our streamlined KYC process.",
  ...
  },
  {
    ...
    icon: TrendingUp,
    title: "Invest",
    description: "Fund your account via Luno — card, bank transfer, or crypto. Your capital is deployed instantly.",
    accent: "from-[#D4AF37]/10 to-[#D4AF37]/[0.02]",
    border: "border-[#D4AF37]/15",
    iconColor: "text-[#D4AF37]",
  },
