...
function seedDemoData() {
  const seeded = localStorage.getItem("gb_admin_seeded");
  if (seeded) return;
  ...
  const demoUsers: Record<string, { name: string; password: string }> = {
    "john.doe@gmail.com": { name: "John Doe", password: "demo1234" },
    "sarah.m@outlook.com": { name: "Sarah Mokoena", password: "demo1234" },
    "thabo.n@yahoo.com": { name: "Thabo Nkosi", password: "demo1234" },
    "linda.v@gmail.com": { name: "Linda van der Berg", password: "demo1234" },
    "sipho.z@icloud.com": { name: "Sipho Zulu", password: "demo1234" },
  };

  Object.entries(demoUsers).forEach(([email, data]) => {
    if (!users[email]) users[email] = data;
  });
  localStorage.setItem("gb_users", JSON.stringify(users));

  // Seed demo deposits
  const existingDeposits = getStoredDeposits();
  if (existingDeposits.length === 0) {
    const demoDeposits: StoredDeposit[] = [
      { id: "dep-1", amount: 15000, currency: "ZAR", walletType: "BTC", txHash: "3FZbgi29cpjq2GjdwV8ey...", proofImage: "", date: "2026-02-20", status: "confirmed", userEmail: "john.doe@gmail.com" },
      { id: "dep-2", amount: 7500, currency: "ZAR", walletType: "USDT", txHash: "0x8a7d3b2f1e9c4a6d...", proofImage: "", date: "2026-02-22", status: "confirmed", userEmail: "sarah.m@outlook.com" },
      { id: "dep-3", amount: 25000, currency: "ZAR", walletType: "BTC", txHash: "bc1qxy2kgdygjrsqt...", proofImage: "", date: "2026-02-25", status: "pending", userEmail: "thabo.n@yahoo.com" },
      { id: "dep-4", amount: 3500, currency: "ZAR", walletType: "ETH", txHash: "0x4e2a91b8d3c7f5e0...", proofImage: "", date: "2026-02-26", status: "confirmed", userEmail: "linda.v@gmail.com" },
      { id: "dep-5", amount: 50000, currency: "ZAR", walletType: "BTC", txHash: "1A1zP1eP5QGefi2DMPTf...", proofImage: "", date: "2026-02-27", status: "pending", userEmail: "sipho.z@icloud.com" },
      { id: "dep-6", amount: 10000, currency: "ZAR", walletType: "USDT", txHash: "TQn9Y2khEsLJW1ChN...", proofImage: "", date: "2026-02-28", status: "rejected", userEmail: "john.doe@gmail.com" },
    ];
    saveDeposits(demoDeposits);
  }

  // Seed demo withdrawals
  const existingWithdrawals = getStoredWithdrawals();
  if (existingWithdrawals.length === 0) {
    const demoWithdrawals: StoredWithdrawal[] = [
      { id: "wd-1", amount: 5000, walletAddress: "bc1qar0srrr7xfkvy5l643lydnw9re59gtzzwf5mdq", walletType: "BTC", date: "2026-02-18", status: "completed", userEmail: "john.doe@gmail.com" },
      { id: "wd-2", amount: 2500, walletAddress: "0x742d35Cc6634C0532925a3b844Bc9e7595f2bD18", walletType: "ETH", date: "2026-02-24", status: "pending", userEmail: "sarah.m@outlook.com" },
      { id: "wd-3", amount: 8000, walletAddress: "TQn9Y2khEsLJW1ChNWShFYKwxhA5sR7CiB", walletType: "USDT", date: "2026-02-26", status: "processing", userEmail: "thabo.n@yahoo.com" },
      { id: "wd-4", amount: 12000, walletAddress: "bc1q9h5yjqka3kz2p0smu2g4jt8dxvr2he2xr3yh6p", walletType: "BTC", date: "2026-02-27", status: "pending", userEmail: "sipho.z@icloud.com" },
    ];
    saveWithdrawals(demoWithdrawals);
  }

  // Seed demo investments
  const existingInvestments = getStoredInvestments();
  if (existingInvestments.length === 0) {
    const demoInvestments: StoredInvestment[] = [
      { id: "inv-1", package: "Premium", amount: 15000, currency: "ZAR", amountZAR: 15000, paymentMethod: "crypto", date: "2026-02-20", status: "Active" },
      { id: "inv-2", package: "Growth", amount: 7500, currency: "ZAR", amountZAR: 7500, paymentMethod: "crypto", date: "2026-02-22", status: "Active" },
      { id: "inv-3", package: "Premium", amount: 25000, currency: "ZAR", amountZAR: 25000, paymentMethod: "crypto", date: "2026-02-25", status: "Pending" },
      { id: "inv-4", package: "Starter", amount: 3500, currency: "ZAR", amountZAR: 3500, paymentMethod: "crypto", date: "2026-02-26", status: "Active" },
      { id: "inv-5", package: "Premium", amount: 50000, currency: "ZAR", amountZAR: 50000, paymentMethod: "crypto", date: "2026-02-27", status: "Pending" },
    ];
    localStorage.setItem("gb_investments", JSON.stringify(demoInvestments));
  }

  localStorage.setItem("gb_admin_seeded", "true");
}
